...
#include <limits>
namespace lve {
	void LveKeyboardController::moveInPlaneXZ(GLFWwindow* window, float dt, LveGameObject& gameObject) {
		/*
		glm::vec3 rotate{ 0 };
		...
		gameObject.transform.rotation.y = glm::mod(gameObject.transform.rotation.y, 2.f * glm::pi<float>());
		*/
